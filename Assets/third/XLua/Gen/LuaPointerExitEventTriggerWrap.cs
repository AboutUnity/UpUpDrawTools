...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaPointerExitEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaPointerExitEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaPointerExitEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaPointerExitEventTrigger constructor!");
        ...
        static int _m_OnPointerExit(RealStatePtr L)
        {
		    try {
                ...
                LuaPointerExitEventTrigger gen_to_be_invoked = (LuaPointerExitEventTrigger)translator.FastGetCSObj(L, 1);
