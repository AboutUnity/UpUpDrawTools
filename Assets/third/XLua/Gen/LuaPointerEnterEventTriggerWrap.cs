...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaPointerEnterEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaPointerEnterEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaPointerEnterEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaPointerEnterEventTrigger constructor!");
        ...
        static int _m_OnPointerEnter(RealStatePtr L)
        {
		    try {
                ...
                LuaPointerEnterEventTrigger gen_to_be_invoked = (LuaPointerEnterEventTrigger)translator.FastGetCSObj(L, 1);
