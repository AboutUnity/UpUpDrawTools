...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaEndDragEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaEndDragEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaEndDragEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaEndDragEventTrigger constructor!");
        ...
        static int _m_OnEndDrag(RealStatePtr L)
        {
		    try {
                ...
                LuaEndDragEventTrigger gen_to_be_invoked = (LuaEndDragEventTrigger)translator.FastGetCSObj(L, 1);
