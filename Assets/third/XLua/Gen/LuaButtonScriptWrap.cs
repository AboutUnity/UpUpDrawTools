...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaButtonScriptWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaButtonScript);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaButtonScript();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaButtonScript constructor!");
        ...
        static int _m_Awake(RealStatePtr L)
        {
		    try {
                ...
                LuaButtonScript gen_to_be_invoked = (LuaButtonScript)translator.FastGetCSObj(L, 1);
