...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaPointerDownEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaPointerDownEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaPointerDownEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaPointerDownEventTrigger constructor!");
        ...
        static int _m_OnPointerDown(RealStatePtr L)
        {
		    try {
                ...
                LuaPointerDownEventTrigger gen_to_be_invoked = (LuaPointerDownEventTrigger)translator.FastGetCSObj(L, 1);
