...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaToggleEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaToggleEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaToggleEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaToggleEventTrigger constructor!");
        ...
        static int _m_OnValueChanged(RealStatePtr L)
        {
		    try {
                ...
                LuaToggleEventTrigger gen_to_be_invoked = (LuaToggleEventTrigger)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_eventItemArray(RealStatePtr L)
        {
		    try {
                ...
                LuaToggleEventTrigger gen_to_be_invoked = (LuaToggleEventTrigger)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.eventItemArray = (LuaToggleEventItem[])translator.GetObject(L, 2, typeof(LuaToggleEventItem[]));
