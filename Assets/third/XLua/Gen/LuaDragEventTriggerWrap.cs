...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaDragEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaDragEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaDragEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaDragEventTrigger constructor!");
        ...
        static int _m_OnDrag(RealStatePtr L)
        {
		    try {
                ...
                LuaDragEventTrigger gen_to_be_invoked = (LuaDragEventTrigger)translator.FastGetCSObj(L, 1);
