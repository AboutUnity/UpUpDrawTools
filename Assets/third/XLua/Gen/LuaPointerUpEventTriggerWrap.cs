...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaPointerUpEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaPointerUpEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaPointerUpEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaPointerUpEventTrigger constructor!");
        ...
        static int _m_OnPointerUp(RealStatePtr L)
        {
		    try {
                ...
                LuaPointerUpEventTrigger gen_to_be_invoked = (LuaPointerUpEventTrigger)translator.FastGetCSObj(L, 1);
