...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaDropEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaDropEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaDropEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaDropEventTrigger constructor!");
        ...
        static int _m_OnDrop(RealStatePtr L)
        {
		    try {
                ...
                LuaDropEventTrigger gen_to_be_invoked = (LuaDropEventTrigger)translator.FastGetCSObj(L, 1);
