...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaPointerClickEventTriggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaPointerClickEventTrigger);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new LuaPointerClickEventTrigger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaPointerClickEventTrigger constructor!");
        ...
        static int _m_OnPointerClick(RealStatePtr L)
        {
		    try {
                ...
                LuaPointerClickEventTrigger gen_to_be_invoked = (LuaPointerClickEventTrigger)translator.FastGetCSObj(L, 1);
